...
class EasyWumpusEnv(object):
    def __init__(self, observationAccu):
        self.stateSpace = [(agentLocation, wumpusLocation) for agentLocation in [0, 1] for wumpusLocation in
                           [0, 1, 2]] + [(0, -1)]
        ...
        def transitionFunction(s, a, sPrime):
            ...
            if a == 1:
                ...
                return (agentLocation == 0 and agentLocationPrime == 1 and wumpusLocation == wumpusLocationPrime) + \
                       (agentLocation == 1 and agentLocationPrime == 0 and wumpusLocation == wumpusLocationPrime)
        ...
        victoryReward = 100
        losingPenalty = -100
        self.rewardFunction = lambda s, a, sPrime: rewardFunctionFull(s, a, sPrime, movingCost, victoryReward,
                                                                      losingPenalty)
